<?php
  ...
  if(isset($_GET['add']) || isset($_GET['edit'])){
    ...
    if ($_POST) {
      ...
      if($_FILES['photo']['name'] != ''){
        ...
        $dbpath = '/E_commerce/images/products/'.$uploadName;
 ...
 <h2 class="text-center"><?=((isset($_GET['edit']))?'Edit':'Add a new');?> Product</h2><hr>
  ...
  <div class="form-group col-md-3">
      ...
      <button class = "btn btn-default" class="form-control" onclick="jQuery('#sizesModal').modal('toggle');return false;">Sizes & Quantities</button>
  </div>
  <div class="form-group col-md-3">
  ...
  <div class="form pull-right">
    <a href="products.php" class="btn btn-default">Cancel</a> &nbsp
